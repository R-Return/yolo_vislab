...
interface ControlPanelProps {
  ...
  onImportCollection: (type: 'images' | 'labels') => void;
    ...
    <div className="w-80 h-screen bg-surface border-r border-slate-700 flex flex-col p-4 overflow-y-auto custom-scrollbar text-sm z-20 relative flex-shrink-0">
      ...
      <div className="space-y-4 mb-8">
        ...
        <div>
          ...
          <button onClick={() => onLoadPred()} className="w-full bg-slate-700 hover:bg-slate-600 text-slate-200 py-2 px-3 rounded flex items-center justify-center gap-2 transition-colors text-xs border border-slate-600 border-dashed">
      ...
      <div className="space-y-4 mb-8">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button onClick={() => onImportCollection('images')} className="bg-slate-700 hover:bg-slate-600 text-slate-200 py-2 rounded flex flex-col items-center justify-center gap-1 transition-colors text-xs p-1">
            <FileImage className="w-4 h-4" /> Add Images
          </button>
          <button onClick={() => onImportCollection('labels')} className="bg-slate-700 hover:bg-slate-600 text-slate-200 py-2 rounded flex flex-col items-center justify-center gap-1 transition-colors text-xs p-1">
